        ...
        <div class="col-md-12">
                ...
                <?php foreach ($cinemaList as $cinema) { ?>
                  <tr>
                    ...
                    <form action="<?php echo FRONT_ROOT . "Cinema/remove" ?>" method="">
                      <td style="text-align: center; vertical-align: middle"><button type="submit" name="id" class="btn btn-danger" value="<?php echo $cinema->getId() ?>"> Remove </button>
                    </form>
                  </tr>
                <?php } ?>
              </tbody>
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              <thead class="thead-dark">
                <tr>  
                  <form action="<?php echo FRONT_ROOT . "Cinema/showAddView" ?>" method="">
                        <td style="text-align: center; vertical-align: middle"><button type="submit" class="btn btn-success"> Add new Cinema </button>
                  </form>   
                </tr>
              </thead>
            </table>
